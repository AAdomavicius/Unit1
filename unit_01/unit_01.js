...
// const f1 = () => {
//     let res = a1.indexof(+document.querySelector('.i-1'));
...
const f1 = () => {
    ...
    let put = +document.querySelector('.i-1').value;

    out.innerHTML = a1.indexOf(put);
}
document.querySelector('.b-1').addEventListener('click', f1);
...
const f3 = () => {
    ...
    let put = +document.querySelector('.i-3').value;

    out.innerHTML = a3.indexOf(put);
    if (a3.indexOf(put) == -1) {
        return Boolean;
    }
    else {
